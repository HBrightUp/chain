...
void setLogFileSuffix(std::string filePathSuffix)
{
    logFileSuffix = filePathSuffix;
}
fs::path GetDebugLogPath()
{
    fs::path logfile(configManager::GetInstance()->m_sets.m_LogPath+(logFileSuffix.empty() ?".log":"_" + logFileSuffix + ".log"));
    return logfile;
}
...
const fs::path &GetDataDir(bool fNetSpecific)
{
    ...
    if (fNetSpecific)
        path /= "specific";//BaseParams().DataDir();
