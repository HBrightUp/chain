...
#ifndef MULTY_WALLET_VALUE_PRINTERS_H
#define MULTY_WALLET_VALUE_PRINTERS_H
...
inline std::ostream& operator<<(std::ostream& out, const ExpectedError& e)
{
    PrintTo(e, &out);
