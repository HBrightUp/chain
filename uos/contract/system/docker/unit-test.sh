...
cd /uosio.contracts/build/tests
...
mv /uosio.contracts/build/tests/Testing/$(ls /uosio.contracts/build/tests/Testing/ | grep '20' | tail -n 1)/Test.xml /artifacts/Test.xml