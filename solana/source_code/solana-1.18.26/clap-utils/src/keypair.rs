...
impl DefaultSigner {
    ...
    pub fn generate_unique_signers(
        ...
        if bulk_signers.iter().any(|signer| signer.is_none()) {
            ...
            //default_signer: Signer: 94wrpKdHY2yXkLXJgXzK5cczt1dKFiCdJYSzuKwpFQTP
            //print!("default_signer: {:?}", default_signer);
        ...
        //unique_signers: [Signer: 94wrpKdHY2yXkLXJgXzK5cczt1dKFiCdJYSzuKwpFQTP]
...
pub fn signer_from_path_with_config(
    ...
    //kind: file, derivation_path: None, legacy: false, path: /home/hml/.config/solana/id.json, keypair_name: keypair
    println!("kind: {:?}, derivation_path: {:?}, legacy: {}, path: {}, keypair_name: {},", kind, derivation_path, legacy, path, keypair_name);
    match kind {
